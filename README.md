...
```console
$ # get chain id
$ curl --data-raw '{"id": "1","jsonrpc": "2.0","method": "eth_chainId","params": []}' -H 'Content-Type: application/json'  'http://localhost:8545' 
{"jsonrpc":"2.0","id":"1","result":"0x440"}
$ # get block by block number
$ curl --data-raw '{"id": "1","jsonrpc": "2.0","method": "eth_getBlockByNumber","params": ["latest",false]}' -H 'Content-Type: application/json'  'http://localhost:8545' 
...
$ curl --data-raw '{"id": "1","jsonrpc": "2.0","method": "eth_sendRawTransaction","params": ["0xf86f81eb8503f5476a00825208940f8b20ed4eecf06eee385f837c94966ba5d800318819ac8532c2790000808208a3a0cde205bfcce3c47687362fbbf3a8c83ecb80c419b4fa751334e17db0a06a4010a0459c4b067ca808046fa8f61211d4876eec9394abcfeeb8e73eb4193f15368acf"]}' -H 'Content-Type: application/json' 'http://localhost:8545'
```
